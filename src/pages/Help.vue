<template>
    <div :class="[theme, 'help-container']">
        ...
        <section id="overview">
            <h2>Overview</h2>
            <p>
                The Nutri View is a tool designed for exploring, analyzing, and visualizing environmental model data
        ...
        <section id="common-concepts">
            ...
            <ul>
                ...
                <li>Click the <strong>📁 Select Folder</strong> button to choose the root folder containing your IMWEBs
                    model data.
                    <ul>
                ...
                <li><strong>Export Path:</strong>
                    <ul>
                        <li><strong>Desktop App:</strong> Specify the directory path on your computer where exported
                            ...
                            data directory (`{Nutri-View App Path}/_up_/backend/apppy/_internal/dataExport`). You can change this to folders like Desktop, Downloads, or Documents.</li>
